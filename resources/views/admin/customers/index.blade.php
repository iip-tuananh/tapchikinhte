...
<script>
    let datatable = new DATATABLE('table-list', {
        ...
        columns: [
            ...
            {data: 'code', title: 'Mã cộng tác viên'},
            {data: 'fullname', title: 'Tên cộng tác viên'},
        ...
        search_columns: [
            {data: 'keywords', search_type: "text", placeholder: "Mã hoặc tên cộng tác viên"},
        ],
    }).datatable;
