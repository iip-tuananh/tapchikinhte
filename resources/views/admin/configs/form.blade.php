...
{{--				</div>--}}
                ...
                <div class="form-group custom-group">
                    <label class="form-label">Về cơ quan chủ quản</label>
                ...
                <div class="form-group custom-group">
                    <label class="form-label">Vè tạp chí</label>
                    <textarea id="my-textarea" class="form-control" ck-editor ng-model="form.web_des_2" rows="3"></textarea>
                    <span class="invalid-feedback d-block" role="alert">
						<strong><% errors.web_des_2[0] %></strong>
					</span>
                </div>


                <div class="form-group custom-group">
                    <label class="form-label">Hướng dẫn gửi bài</label>
                    <textarea id="my-textarea" class="form-control" ck-editor ng-model="form.web_des_3" rows="3"></textarea>
                    <span class="invalid-feedback d-block" role="alert">
						<strong><% errors.web_des_3[0] %></strong>
					</span>
                </div>
